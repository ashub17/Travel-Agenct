...
?>
  ...
  <div class="w3-row w3-large w3-center" style="margin:32px 0">
    ...
    <div class="w3-third"><i class="fa fa-phone w3-text-red"></i> Phone: +8801953594202</div>
    <div class="w3-third"><i class="fa fa-envelope w3-text-red"></i> Email: ashubbinasad@gmail.com</div>
  </div>
  ...
  <div class="w3-container" id="contact">
    ...
    <i class="fa fa-envelope w3-text-red" style="width:30px"> </i> Email: ashubbinasad@gmail.com<br>
...
<footer class="w3-padding-32 w3-black w3-center w3-margin-top">
  ...
  <p> <small>&copy; Copyright 2018, Ashub</small></p>
</footer>
